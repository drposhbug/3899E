...
void autonRoutine9() {
  setStartPosition(100, 100, 100);  // Start at (100cm, 50cm) facing right (90 degrees)
 // Brain.Screen.printAt(10, 100, "START - X: %.2f, Y: %.2f, H: %.2f", 
                        globalX, globalY, getAdjustedHeading());
 ...
 wait(2500, msec);  // Wait slightly longer than the delay + movement time
  ...
  //  straightToPoint(0, 50, 15, 16, 0.0, 0, 0, 0.2, 0.2, 0.2);
    ...
    //turnToPoint(100, 200, 80);
        ...
        Brain.Screen.printAt(10, 1200, "END - X: %.2f, Y: %.2f, H: %.2f", 
                        globalX, globalY, getAdjustedHeading());
