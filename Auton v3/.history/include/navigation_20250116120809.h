...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 90, double kp_heading = 0.5, double ki_heading = 0.0, double kd_heading = 0.0, double accelHeadingScaling = 0.4, double decelHeadingScaling = 0.2, double approachHeadingScaling = 0.0, double minSpeed = 15);
...
private:
    static constexpr double ABSLockThreshold = 10; // 0 is full stop, no ABS, 1 is at or near full coast ( 0.6 seems good). Working range is 0.8 to 0.9
};
...
private:
    static constexpr double ABSLockThreshold = 0.15;  // Using your original name
};
