...
const double DRIVE_MOTOR_RPM_ADJ = 0.857143; //Motor encoder RPM returns a max RPM of 700+.  This brings it back to 600 RPM.
...
static constexpr double TRACK_WIDTH = 30.5; // distance between left and right wheels in cm 
static constexpr double DISTANCE_TO_ENCODER = 9; 
static constexpr double ENCODER_RADIUS_RATIO = DISTANCE_TO_ENCODER / (TRACK_WIDTH / 2.0);
