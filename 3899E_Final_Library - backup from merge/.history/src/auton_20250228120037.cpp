...
void skills()
{
   ...
   wait(500, msec);
    ...
    rightMP(35,45,18); 
    armMotor1.spinToPosition(Load1-10, rotationUnits::deg, 100, velocityUnits::pct, false);
    armMotor2.spinToPosition(Load1-10, rotationUnits::deg, 100, velocityUnits::pct, false);     
   

    forwardMP(100, 50, 35, 23, 0.6, 0.003, 0.01);
