...
void skills()
{
    I can help you call the color detection task within an autonomous function. Based on the code from utils.cpp, you'll need to:

Create and initialize the parameters for the color detection task
Start the task
Properly end it when your autonomous routine is complete

Here's how to implement this in an autonomous function:
cppCopyvoid autonomous() {
    ...
    // Start the color detection task
    task colorTask(colorDetectionTask, &colorParams);
