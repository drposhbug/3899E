...
*/
        ...
        if (Controller.ButtonRight.pressing()) { 
            if (!wasRightPressed) { // Detect the press event and ensure arm is not moving
                ...
                isArmPneumaticsActive = !isArmPneumaticsActive;
                armPneumatics.set(isArmPneumaticsActive);
                // To extend the piston
armPneumatics.set(true);  // or armPneumatics.open()

// To retract the piston
armPneumatics.set(false); // or armPneumatics.close()
