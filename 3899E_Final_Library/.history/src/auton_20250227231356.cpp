...
const double BLUE_HUE_MAX = 230.0;  // Reduced from 240
   ...
   ArmResetTaskParams armResetParams;
    ...
    //go to Alliance Stake
   armMotor1.spinToPosition(450, rotationUnits::deg, 100, velocityUnits::pct, true);
   armMotor2.spinToPosition(450, rotationUnits::deg, 100, velocityUnits::pct, true);
   wait(400, msec);

    //Backup to Pick up Mobile Goal #1
    backwardMP(57, 33, 224, 16, 1.5, 0.0008, 0.5, 0.35);
    // Start the task
armResetParams.isRunning = true;
armResetParams.isResetComplete = false;
vex::task armResetTaskInstance(armResetTask, &armResetParams);
    rightMP(90,75,20); 
    ...
    armMotor1.spinToPosition(Load1-30, rotationUnits::deg, 100, velocityUnits::pct, false);
    armMotor2.spinToPosition(Load1-30, rotationUnits::deg, 100, velocityUnits::pct, false);
    rightMP(37,75,20); 
    intakeMotor.spin(forward, 100, velocityUnits::pct);
    forwardMP(100, 50, 37, 16, 1.5, 0.03, 0.1);
    armMotor1.spinToPosition(Side-30, rotationUnits::deg, 100, velocityUnits::pct, false);
    armMotor2.spinToPosition(Side-30, rotationUnits::deg, 100, velocityUnits::pct, false);
