...
void pidStraightDistanceLaunchABS(double targetHeading, double targetDistance, double maxSpeed = 70, double kp_heading = 0.4, double ki_heading = 0, double kd_heading = 0, double minSpeed = 10, double accelHeadingScaling, double decelHeadingScaling, double breakDistance = 25); 
