...
//spotTurnMP(-180, 100, 7.5, 85); //good 180 degrees decel distance and min speed without load
spotTurnMP(-180, 100, 7.5, 120);
...
pidStraightDistanceABS(0, -10, 100, .15, 0, 0, 1, 0, 0, 15, 5);  
spotTurn(-67, 70, 2, 0.4, 0, 0.05);
pidStraightDistanceABS(-70, 33, 80, .15, 0, 0, 1, 0, 0, 15, 20); 
//intakeMotor.spin(directionType::rev, 12, voltageUnits::volt);
