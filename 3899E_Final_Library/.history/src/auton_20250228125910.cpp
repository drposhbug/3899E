...
//Scoring on side Stake
    ...
    forwardMP(93, 60, 32, 20, 0.6, 0.003, 0.01);
    ...
    armMotor2.spinToPosition(Starting, rotationUnits::deg, 100, velocityUnits::pct, true);
    backwardMP(10, 8, 4, 20, 1.5, 0.0008, 0.5, 0.35);
    rightMP(270,67,20); 
    forwardMP(93, 60, 270, 20, 0.6, 0.003, 0.01);
