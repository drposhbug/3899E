...
const double BLUE_HUE_MAX = 230.0;  // Reduced from 240
   ...
   ArmResetTaskParams armResetParams;
    ...
    /*
    //go to Alliance Stake
   armMotor1.spinToPosition(450, rotationUnits::deg, 100, velocityUnits::pct, false);
   armMotor2.spinToPosition(450, rotationUnits::deg, 100, velocityUnits::pct, false);
   wait(300, msec);

    //Backup to Pick up Mobile Goal #1
    backwardMP(47, 20, 224, 16, 1.5, 0.0008, 0.5, 0.35);
    goalPneumatics.set(true);
