...
goalPneumatics.set(true);
armMotor.spinToPosition(-20, rotationUnits::deg, 100, velocityUnits::pct, true);
turnOdometry(100, 75, 25);
straightOdometry(45, 20,17,100);
doinkerPneumatics.set(true);
backward(-40,20,17,100); 
turnOdometry(225, 180, 25);
intakeMotor.spin(reverse, 100, velocityUnits::pct);
doinkerPneumatics.set(false);
straightOdometry(45, 20,17,227);
