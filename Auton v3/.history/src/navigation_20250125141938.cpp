...
*/
  ...
  //  decelCompleted = true;
    // If all drivetrain motors decel to min speed then change DecelCompleted State variable to true to start Approach Phase
leftEncoderRollingAverage = rollingAverage(leftEncoderRPM,leftEncoderRollingAverage, 1);
rightEncoderRollingAverage = rollingAverage(leftEncoderRPM,leftEncoderRollingAverage, 1);
