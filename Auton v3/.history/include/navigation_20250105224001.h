...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 10, double kp_heading = 1.25, double ki_heading = 0, double kd_heading = 0.0, double accelHeadingScaling = 0, double decelHeadingScaling = 0, double approachHeadingScaling = 1, double minSpeed = 10);
