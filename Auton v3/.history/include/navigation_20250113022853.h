...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 90, double kp_heading = 1.2, double ki_heading = 0.0, double kd_heading = 0.0, double accelHeadingScaling = 0.05, double decelHeadingScaling = 1, double approachHeadingScaling = 1, double minSpeed = 15);
