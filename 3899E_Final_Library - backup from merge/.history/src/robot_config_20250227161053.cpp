...
vex::motor armMotor1 = vex::motor(vex::PORT17, vex::gearSetting::ratio18_1, false); // 5.5W motor
...
vex::bumper armBumper1(Brain.ThreeWirePort.C);
vex::bumper armBumper2(Brain.ThreeWirePort.F);
