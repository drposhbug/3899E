...
public:
    tractionControl(double minSpeedVoltage, double maxSpeedVoltage);
    double tractionControlSpeed(double tractionMotorVoltage, double motorSpeed, double robotSpeed);

private:
    double minSpeedVoltage;
    double maxSpeedVoltage;
    static constexpr double slipThreshold = 0.7; // Class-wide constant
    static constexpr double accelFactor = 1.1;
}; 
...
class ABSController {
public:
    ABSController(double motorSpeed, double robotSpeed, double minSpeedVoltage); // Added brakeMode parameter
    ABSReturn ABSSpeedReduction(double ABSMotorVoltage);
