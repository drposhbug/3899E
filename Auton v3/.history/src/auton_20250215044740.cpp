...
*/
  ...
  void autonRoutine12() {
    straightOdometry(17.5, 9);
    armMotor.spinToPosition(570, rotationUnits::deg, 100, velocityUnits::pct, true);
    backward(-80,48,25,3, 2);  // Changed -3 to 3 (relative)
    goalPneumatics.set(true);
    armMotor.spinToPosition(-40, rotationUnits::deg, 100, velocityUnits::pct, true);
    turnOdometry(-115, 75, 25);  // Changed 93 to -93 (relative)
    straightOdometry(48, 20,17,-115,0.2);  // Changed 93 to -93 (relative)
    doinkerPneumatics.set(true);
