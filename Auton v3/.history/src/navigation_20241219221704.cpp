...
void spotTurnMP(double targetHeading, double maxSpeed, double minSpeed, double breakDistanceInDegrees, double accelHeadingScaling, double decelHeadingScaling, double approachHeadingScaling) { 
    ...
    double minRadiansPerSecond = (2 * fabs(minRPM * (wheelCircumferenceCM / 60.0))) / trackWidth; //convert minspeed to percentage first
    double maxRadiansPerSecond = (2 * fabs(maxRPM * (wheelCircumferenceCM / 60.0))) / trackWidth; //convert maxspeed to percentage first
