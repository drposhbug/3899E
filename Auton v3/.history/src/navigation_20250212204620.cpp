...
double currentHeading = InertialSensor.heading();
double headingError = -fmod(targetHeading - currentHeading + 540.0, 360.0) + 180.0;  // Note the negative and swapped subtraction
...
headingError = -fmod(targetHeading - currentHeading + 540.0, 360.0) + 180.0;
