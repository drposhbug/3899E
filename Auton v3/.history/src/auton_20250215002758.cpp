...
straightOdometry(48, 20,17,93,0.3);
doinkerPneumatics.set(true);
backward(-40,20,17,95,2.2); 
turnOdometry(215, 180, 25);
intakeMotor.spin(reverse, 100, velocityUnits::pct);
doinkerPneumatics.set(false);
turnOdometry(230, 195, 25);
straightOdometry(45, 20,17,230,0.4);
turnOdometry(310, 280, 25);
straightOdometry(90, 45,17,310);
