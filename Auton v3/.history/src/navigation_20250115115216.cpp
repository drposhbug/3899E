...
*/        
    ...
    //Launch Phase
    if (fabs(currentDistance) < fabs(fabs(targetDistance) - fabs(breakDistance)) && !accelCompleted && !decel) { //will keep going until acceleration is complete and not in decel
...
/*
  ...
  */     
    ...
    //Cruise Phase      
    } else if (fabs(currentDistance) < fabs(fabs(targetDistance) - fabs(breakDistance)) && accelCompleted == true) {
    break;  
        Brain.Screen.printAt(10, 20, "Cruise Phase");    // Else condition - specify actions here if the if condition is not met
    ...
    // Decel Phase
    //If declerating then go to ABS routine
    } else if (fabs(currentDistance) >= fabs(fabs(targetDistance) - fabs(breakDistance)) && decelCompleted == false) {  
    //break;   
