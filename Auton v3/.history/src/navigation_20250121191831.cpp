...
void spotTurnMP(double turnDegrees, double maxSpeed, double minSpeed, double breakDistanceInDegrees) { 
    ...
    double launchVoltage = std::copysign(10, targetDistanceInDegrees); //3.5 is good
    ...
    double slipThresholdSpotTurn = 0.25; // the lower it is below 1, the slower and more controlled it will be
    double ABSLockThresholdSpotTurn = 10;
...
Brain.Screen.printAt(10, 20, "Decel Phase");
    ...
    for (int i = 0; i < 3; i++) {   
        ...
        //Left Side
        brakeType leftBrakeMode = ABSControllerLeft[i].ABSSpeedReduction(leftMotorRPM[i], leftEncoderRPM);
        ...
        //Right Side
        brakeType rightBrakeMode = ABSControllerRight[i].ABSSpeedReduction(rightMotorRPM[i], rightEncoderRPM);
