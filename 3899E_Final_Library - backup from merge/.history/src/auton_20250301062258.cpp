...
armMotor1.spinToPosition(300, rotationUnits::deg, 100, velocityUnits::pct, false);
armMotor2.spinToPosition(300, rotationUnits::deg, 100, velocityUnits::pct, false);
    ...
    backwardMP(110, 0, 358, 20, 0.5, 0, 0);
