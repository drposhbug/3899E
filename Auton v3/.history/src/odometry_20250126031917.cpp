...
void straightToPoint(double targetX, double targetY,
                double maxSpeed, double breakDistance,
                ...
                double minSpeed)
{
    ...
    straight(targetDistance, double breakDistance = 90, double minSpeed = 15, double targetHeading = 0, double kp_heading = 0.2, double ki_heading = 0.0, double kd_heading = 0.0, double accelHeadingScaling = 0.4, double decelHeadingScaling = 0.25, double approachHeadingScaling = 0.25, double maxSpeed = 100);            
