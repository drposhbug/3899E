...
*/
  ...
  void autonRoutine12() {
    straightOdometry(17, 9,17,1);
    armMotor.spinToPosition(570, rotationUnits::deg, 100, velocityUnits::pct, true);
    backward(-78,48,25,3, 2);  // Changed -3 to 3 (relative)
    goalPneumatics.set(true);
    armMotor.spinToPosition(-40, rotationUnits::deg, 100, velocityUnits::pct, true);
    turnOdometry(-117, 75, 25);  // Changed 93 to -93 (relative)
    straightOdometry(50, 20,17,-117,0.2);  // Changed 93 to -93 (relative)
    doinkerPneumatics.set(true);
