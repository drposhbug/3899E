...
void turnOdometry(double targetHeading, double breakDistanceInDegrees, double minSpeed, double maxSpeed)
{
    ...
    {
        currentHeading = InertialSensor.heading(degrees); // Changed from rotation() to heading()
                      ...
                      double maxSpeed)
{
    ...
    while (std::fabs(currentDistance) <= fabs(targetDistance) - 4)
    {
        ...
        */
        ...
        Brain.Screen.setCursor(1, 1);
        Brain.Screen.print("Target: %.1f", targetHeading);
        Brain.Screen.setCursor(2, 1);
        Brain.Screen.print("Current: %.1f", currentHeading);
        Brain.Screen.setCursor(3, 1);
        Brain.Screen.print("Error: %.1f", headingError);
        Brain.Screen.setCursor(4, 1);
        Brain.Screen.print("Correction: %.1f", headingCorrection);
