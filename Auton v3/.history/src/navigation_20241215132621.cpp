...
tractionControl::tractionControl(double minSpeedVoltage, double maxSpeedVoltage)
    : minSpeedVoltage(minSpeedVoltage), maxSpeedVoltage(maxSpeedVoltage) {} // Initialized slipThreshold

    // adjustSpeed method implementation
    double tractionControl::tractionControlSpeed(double tractionMotorVoltage, double robotSpeed, double motorSpeed) { 
