...
tractionControl::tractionControl(double minSpeedVoltage, double maxSpeedVoltage)
    ...
    // adjustSpeed method implementation
    double tractionControl::tractionControlSpeed(double tractionMotorVoltage, double wheelSpeed, double robotSpeed) { 
...
// adjustSpeed method implementation
ABSReturn ABSController::ABSSpeedReduction(double ABSMotorVoltage, double wheelSpeed, double robotSpeed) {
