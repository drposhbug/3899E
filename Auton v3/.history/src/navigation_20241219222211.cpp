...
void spotTurnMP(double targetHeading, double maxSpeed, double minSpeed, double breakDistanceInDegrees, double accelHeadingScaling, double decelHeadingScaling, double approachHeadingScaling) { 
    ...
    double percentSpeedLoss = .9;
    double totalMotorRadiansPerSecond = 0.0;
    double minRadiansPerSecond = (2 * fabs(maxRPM * (minSpeed * .01) * (wheelCircumferenceCM / 60.0))) / trackWidth; //convert minspeed to percentage first
    double maxRadiansPerSecond = (2 * fabs((maxRPM * (maxSpeed * .01) * (wheelCircumferenceCM / 60.0))) / trackWidth; //convert maxspeed to percentage first
    (2 * fabs(maxRPM * (wheelCircumferenceCM / 60.0))) / trackWidth;
