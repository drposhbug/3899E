...
private:
    double minSpeedVoltage;
    double maxSpeedVoltage;
    static constexpr double slipThreshold = 1.05; // Class-wide constant
...
class ABSController {
public:
    ABSController(double minSpeedVoltage); // Added brakeMode parameter
    ABSReturn ABSSpeedReduction(double motorVoltage, double wheelSpeed, double robotSpeed);
