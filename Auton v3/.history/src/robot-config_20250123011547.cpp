...
const double DRIVE_MOTOR_RPM_ADJ = 0.857143; //0.857143 Motor encoder RPM returns a max RPM of 700+.  This brings it back to 600 RPM.
...
const double ENCODER_RADIUS_RATIO = (TRACK_WIDTH / 2.0) / DISTANCE_TO_ENCODER;
