...
Brain.Screen.setCursor(4,1);
Brain.Screen.print("abs(max): %.1f abs(launch): %.3f", fabs(maxSpeedVoltage), fabs(launchVoltage));
Brain.Screen.setCursor(5,1);
Brain.Screen.print("min result: %.1f", std::min(fabs(maxSpeedVoltage), fabs(launchVoltage)));
Brain.Screen.setCursor(6,1);
Brain.Screen.print("final: %.1f", std::copysign(std::min(fabs(maxSpeedVoltage), fabs(launchVoltage)), targetDistance));
