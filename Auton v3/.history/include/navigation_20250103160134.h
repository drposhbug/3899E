...
void straight(double targetHeading, double targetDistance, double maxSpeed, double breakDistance, double kp_heading = 0.5, double ki_heading = 0, double kd_heading = 0, double accelHeadingScaling = 1, double decelHeadingScaling = 1, double approachHeadingScaling = 1, double minSpeed = 20);
