...
//wait(300, msec);
  //  armPneumatics.set(false);
    ...
    armMotor1.spinToPosition(Alliance-75, rotationUnits::deg, 100, velocityUnits::pct, false);
    armMotor2.spinToPosition(Alliance-75, rotationUnits::deg, 100, velocityUnits::pct, false);
