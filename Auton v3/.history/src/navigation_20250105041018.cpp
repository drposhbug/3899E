...
for (int i = 0; i < 3; i++) {   
    ...
    //}
    if (motorBrakeModeLeft[i] == vex::brakeType::coast || motorBrakeModeRight[i] == vex::brakeType::coast) {
        motorBrakeModeLeft[i] = vex::brakeType::coast;
        motorBrakeModeRight[i] = vex::brakeType::coast;
    }
