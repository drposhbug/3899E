...
void pidStraightDistanceLaunchABS(double targetHeading, double targetDistance, double maxSpeed = 70, double kp_heading = 1, double ki_heading = 0, double kd_heading = 0.0, double minSpeed = 10, double accelHeadingScaling = 0, double decelHeadingScaling = 10, double breakDistance = 25); 
...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 10, double kp_heading = 1, double ki_heading = 0.01, double kd_heading = 0.0, double accelHeadingScaling = 0, double decelHeadingScaling = 10, double approachHeadingScaling = 1, double minSpeed = 10);
...
private:
    static constexpr double ABSLockThreshold = 50; // Class-wide constant
};
