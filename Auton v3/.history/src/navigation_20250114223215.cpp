...
Brain.Screen.print("abs(max): %.1f abs(launch): %.3f", abs(maxSpeedVoltage), abs(launchVoltage));
Brain.Screen.setCursor(13,1);
Brain.Screen.print("min result: %.1f", std::min(abs(maxSpeedVoltage), abs(launchVoltage)));
Brain.Screen.setCursor(14,1);
Brain.Screen.print("final: %.1f", std::copysign(std::min(abs(maxSpeedVoltage), abs(launchVoltage)), targetDistance));
