...
vex::motor armMotor1 = vex::motor(vex::PORT14, vex::gearSetting::ratio18_1, false); // 5.5W motor
vex::motor armMotor2 = vex::motor(vex::PORT17, vex::gearSetting::ratio18_1, false); // 5.5W motor
