...
//break;    
  ...
  Brain.Screen.printAt(10, 20, "Decel Phase");
    ...
    for (int i = 0; i < 3; i++) {   
        ...
        motorVoltageLeft[i] = 1; // Extract motor voltage from ABSResult
        leftMotor[i].setBrake(brake); // Set brake mode from ABSResult
        leftMotor[i].stop();
        ...
        motorVoltageRight[i] = 1; // Extract motor voltage from ABSResult
        rightMotor[i].setBrake(brake); // Set brake mode from ABSResult
