...
Brain.Screen.print("abs(max): %.3f abs(launch): %.3f", abs(maxSpeedVoltage), abs(launchVoltage));
Brain.Screen.setCursor(13,1);
Brain.Screen.print("min result: %.3f", std::min(abs(maxSpeedVoltage), abs(launchVoltage)));
Brain.Screen.setCursor(14,1);
Brain.Screen.print("final: %.3f", std::copysign(std::min(abs(maxSpeedVoltage), abs(launchVoltage)), targetDistance));
