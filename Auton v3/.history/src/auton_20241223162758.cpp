...
vex::task::sleep(500); 
armMotor.spinToPosition(-500, rotationUnits::deg, 100, velocityUnits::pct, false);
spotTurn(24, 70, 2, 0.4, 0, 0.05);
pidStraightDistanceABS(24, -40, 80, .15, 0, 0, 1, 0, 0, 15, 20);
/*
