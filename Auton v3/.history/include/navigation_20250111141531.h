...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 90, double kp_heading = 0, double ki_heading = 0.0, double kd_heading = 0.0, double accelHeadingScaling = 0, double decelHeadingScaling = 50, double approachHeadingScaling = 1, double minSpeed = 10);
...
private:
    static constexpr double ABSLockThreshold = 0.848; // 0 is full stop, no ABS, 1 is at or near full coast ( 0.8485 seems good). Working range is 0.8 to 0.9
};
