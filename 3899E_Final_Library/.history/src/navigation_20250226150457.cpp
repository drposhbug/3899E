...
no that's not it. I'm using the same PID as forward and no issues.  Also, it seems clear now that the heading direction for backward is already acconted for somethere.  Check else
