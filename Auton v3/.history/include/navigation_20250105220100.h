...
void pidStraightDistanceLaunchABS(double targetHeading, double targetDistance, double maxSpeed = 70, double kp_heading = 0.4, double ki_heading = 0, double kd_heading = 0, double minSpeed = 10, double accelHeadingScaling = 0, double decelHeadingScaling = 1.25, double breakDistance = 25); 
...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 10, double kp_heading = 2.2, double ki_heading = 0, double kd_heading = 0.2, double accelHeadingScaling = 0, double decelHeadingScaling = 0, double approachHeadingScaling = 1, double minSpeed = 10);
