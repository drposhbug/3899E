...
void straight(double targetDistance, 
    ...
    //Launch Phase
    if (fabs(currentDistance) < fabs(fabs(targetDistance) - fabs(breakDistance)) && !accelCompleted && !decelCompleted) { //will keep going until acceleration is complete and not in decel
