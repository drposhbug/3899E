...
void straight(double targetDistance, double maxSpeed = 100, double targetHeading = 0, double breakDistance = 90, double kp_heading = 0.3, double ki_heading = 0.0, double kd_heading = 0.0, double accelHeadingScaling = 0.4, double decelHeadingScaling = 0.25, double approachHeadingScaling = 0.0, double minSpeed = 15);
...
private:
    static constexpr double ABSLockThreshold = 0.3;  // Using your original name
};
