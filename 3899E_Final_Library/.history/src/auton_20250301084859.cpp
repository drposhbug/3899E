...
armMotor2.spinToPosition(180, rotationUnits::deg, 100, velocityUnits::pct, false);
   ...
   // forwardMP(98, 50, 26, 16, 1.5, 0.03, 0.1);
    ...
    armMotor1.spinToPosition(Side-50, rotationUnits::deg, 100, velocityUnits::pct, false);
    armMotor2.spinToPosition(Side-50, rotationUnits::deg, 100, velocityUnits::pct, true);
    wait(300, msec);
