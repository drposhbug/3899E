                 ...
                 double minSpeed, double maxSpeed)
{
    ...
    double targetHeading = atan2(targetY - globalY, targetX - globalX) * 180.0 / M_PI;
    targetHeading = normalizeHeading(targetHeading);  // Get the absolute heading we want to face
    
    // Calculate how much we need to turn from our current heading
    double turnAmount = normalizeHeading(targetHeading - globalHeading);
