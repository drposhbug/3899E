        ...
        if (Controller.ButtonL2.pressing())
        {
            ...
            {                       // Detect the press event
                ...
                if (armstat == ArmPosition::Load1 || armstat == ArmPosition::Load2)
                {
                    ...
                    armMotor1.spinToPosition(Hover, rotationUnits::deg, 40, velocityUnits::pct, false);
                    armMotor2.spinToPosition(Hover, rotationUnits::deg, 40, velocityUnits::pct, false);
                ...
                else if (armstat == ArmPosition::Hover)
                {
                    ...
                    armMotor1.setBrake(brakeType::hold);
                    armMotor2.setBrake(brakeType::hold);
                    armMotor1.spinToPosition(Side, rotationUnits::deg, 30, velocityUnits::pct, false);
                    armMotor2.spinToPosition(Side, rotationUnits::deg, 30, velocityUnits::pct, false);
