...

{
    ...
    void autonomous(void) {
        // Calibrate inertial sensor if needed
        ...
        // Parameters: (startX, startY, startHeading)
        initializeOdometry(0, 0, 0);
        
        // Wait a moment for the odometry system to stabilize
        wait(100, msec);
    }
...
backwardMP(100, 47, 0, 18, 0.8, 0.01, 0.1, 0.2);
