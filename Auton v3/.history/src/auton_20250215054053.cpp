...
*/
  ...
  void autonRoutine12() {
    ...
    goalPneumatics.set(true);
    armMotor.spinToPosition(-40, rotationUnits::deg, 100, velocityUnits::pct, true);
    turnOdometry(-124, 95, 20);  // Changed 93 to -93 (relative)
    straightOdometry(59, 35,17,-124,0.3);  // Changed 93 to -93 (relative)
    doinkerPneumatics.set(true);
    wait(500,msec);
    ...
    intakeMotor.spin(reverse, 100, velocityUnits::pct);
    doinkerPneumatics.set(false);
   turnOdometry(-189, 170, 17);  // Changed 168 to 192 (absolute, 360-168=192)
    //turnOdometry(125, 195, 25);  // Changed 235 to 125 (absolute, 360-235=125)
    straightOdometry(35, 25,17,-189,0.2);  // Changed 168 to 192 (matching above absolute heading)
   // backward(-35,20,17,-189);  // Changed 95 to -95 (relative)
    wait(1000,msec);
    turnOdometry(-210, 195, 20);
    straightOdometry(35, 25,17,210,0.2);  // Changed 168 to 192 (matching above absolute heading)
