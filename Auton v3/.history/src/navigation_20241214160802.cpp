...
void spotTurnMP(double targetHeading, double maxSpeed, double minSpeed, double breakDistanceInDegrees, double accelHeadingScaling = 1.5, double decelHeadingScaling = 1.5, double approachHeadingScaling = 1.5) { 
    double normTargetHeading = normalizeHeading(targetHeading);
   ...
   // MotionPhase currentPhase = READY; 
    ...
    // Declare arrays of Slip Control instances for each wheel
    tractionControl tractionControlLeft[3] = {tractionControl(leftMotorRadiansPerSecond[0], robotRadiansPerSecond, minLaunchSpeedVoltage, maxSpeedVoltage),
                                              tractionControl(leftMotorRadiansPerSecond[1], robotRadiansPerSecond, minLaunchSpeedVoltage, maxSpeedVoltage),
                                              tractionControl(leftMotorRadiansPerSecond[2], robotRadiansPerSecond, minLaunchSpeedVoltage, maxSpeedVoltage)};
                                
    tractionControl tractionControlRight[3] = {tractionControl(rightMotorRadiansPerSecond[0], robotRadiansPerSecond, minLaunchSpeedVoltage, maxSpeedVoltage),
                                               tractionControl(leftMotorRadiansPerSecond[1], robotRadiansPerSecond, minLaunchSpeedVoltage, maxSpeedVoltage),
                                               tractionControl(leftMotorRadiansPerSecond[2], robotRadiansPerSecond, minLaunchSpeedVoltage, maxSpeedVoltage)};
...
ABSController ABSControllerRight[3] = {ABSController(rightMotorRadiansPerSecond[0], robotRadiansPerSecond, minSpeedVoltage),
                   ABSController(rightMotorRadiansPerSecond[1], robotRadiansPerSecond, minSpeedVoltage),
                   ABSController(rightMotorRadiansPerSecond[2], robotRadiansPerSecond, minSpeedVoltage)};
