...
vex::motor armMotor = vex::motor(vex::PORT17, vex::gearSetting::ratio18_1, tr); // 5.5W motor
vex::motor armMotor = vex::motor(vex::PORT17, vex::gearSetting::ratio18_1, true); // 5.5W motor
