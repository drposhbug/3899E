...
double currentHeading = getAdjustedHeading();                 // Get continuous rotation
...
double headingError = currentHeading - continuousTarget;          // Raw error
...
double currentDistanceInDegrees = headingError;
    ...
    Brain.Screen.printAt(10, 120, "Heading Error: %.2f", headingError);
