...
straightOdometry(-25, 20, 15, 0, 0.4);
...
void autonRoutine11()
{
    ...
    turnOdometry(90, 75, 25);
        wait(2000, msec);
    straightOdometry(50, 20, 17, 90, 0.3);
    wait(2000, msec);
    doinkerPneumatics.set(true);

    //Coming out of Tower
    straightOdometry(-50, 20, 17, 90, 0.3);
    turnOdometry(220, 130, 25);
    goalPneumatics.set(false);

    straightOdometry(20, 10, 17, 220, 0.3);
    wait(2000, msec);
    doinkerPneumatics.set(false);


    backward(-47,20,17,140,2.2);
