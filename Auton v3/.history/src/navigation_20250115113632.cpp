...
void straight(double targetDistance, 
    ...
    //Launch Phase
    if (std::fabs(currentDistance) < (std::fabs(targetDistance) - breakDistance) && !accelCompleted && !decelCompleted ) { //will keep going until acceleration is complete and not in decel
