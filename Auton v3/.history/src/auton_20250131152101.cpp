...
intakeMotor.spinFor(-7000, rotationUnits::deg, 100, velocityUnits::pct, false);

  //Score Alliance
  straight(100, 60); // use this one
  armMotor.spinToPosition(550, rotationUnits::deg, 100, velocityUnits::pct,false);
    straight(-25, 10); // use this one
  turn(-90, 50, 20);
      straight(-60, 30); // use this one
       goalPneumatics.set(true);
       intakeMotor.spinFor(-6000, rotationUnits::deg, 100, velocityUnits::pct, false);
