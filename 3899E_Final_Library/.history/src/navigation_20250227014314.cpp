        ...
        if (!decel == true || decelCompleted == true)
        {
            if (headingError > 0) { // Counter-clockwise turn (positive error)
                // Left side stationary, right side moves
                    leftMotor[0].stop(coast); // Left side stays stationary
                    ...
                    leftMotor[2].stop(coast); // Left side stays stationary
                ...
                // Right side stationary, left side moves
                    ...
                    rightMotor[0].stop(coast); // Right side stays stationary
                    ...
                    rightMotor[2].stop(coast); // Right side stays stationary
                }
