...
void pidStraight(double targetDistance);
...
void pidStraightDistanceLaunchABS(double targetHeading, double targetDistance, double maxSpeed = 70, double kp_heading = 0.4, double ki_heading = 0, double kd_heading = 0, double kp_distance = 0.09, double ki_distance = 0, double kd_distance = 0, double minSpeed = 10, double breakDistance = 25); 
...
class slipControl {
public:
    slipControl(vex::motor& motor, vex::rotation& encoder, double minSpeedVoltage); // Default value changed to 0.1
