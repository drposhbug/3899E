                ...
                double minSpeed)
{
    ...
    straight(targetDistance, breakDistance, minSpeed, targetHeading, kp_heading, ki_heading, kd_heading, accelHeadingScaling, decelHeadingScaling, approachHeadingScaling, maxSpeed;            
