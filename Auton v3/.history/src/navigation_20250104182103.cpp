...
for (int i = 0; i < 3; i++) {   
    ...
    //Right Side
    vex::brakeType rightBrakeMode = ABSControllerRight[i].ABSSpeedReduction(rightMotorRPM[i], rightEncoderRPM); // Direct brake mode
    ...
    //}
    rightMotor[i].stop(rightBrakeMode); // Set brake mode from ABSResult
