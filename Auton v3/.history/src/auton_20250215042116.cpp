...
*/
  ...
  void autonRoutine12() {
    straightOdometry(18, 9);
    armMotor.spinToPosition(570, rotationUnits::deg, 100, velocityUnits::pct, true);
    backward(-91,48,25,3, 2);  // Changed -3 to 3 (relative)
    goalPneumatics.set(true);
    armMotor.spinToPosition(-40, rotationUnits::deg, 100, velocityUnits::pct, true);
    turnOdometry(-93, 75, 25);  // Changed 93 to -93 (relative)
    //straightOdometry(46, 20,17,-93,0.3);  // Changed 93 to -93 (relative)
    //doinkerPneumatics.set(true);
    //backward(-47,20,17,-95,2.2);  // Changed 95 to -95 (relative)
    //turnOdometry(220, 180, 25);  // Changed 140 to 220 (absolute, 360-140=220)
    //intakeMotor.spin(reverse, 100, velocityUnits::pct);
    //doinkerPneumatics.set(false);
    //turnOdometry(192, 195, 20);  // Changed 168 to 192 (absolute, 360-168=192)
    //turnOdometry(125, 195, 25);  // Changed 235 to 125 (absolute, 360-235=125)
    //straightOdometry(35, 25,17,192,0.4);  // Changed 168 to 192 (matching above absolute heading)
  }