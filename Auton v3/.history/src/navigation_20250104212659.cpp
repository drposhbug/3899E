...
for (int i = 0; i < 3; i++) {   
    ...
    leftMotor[i].stop(leftBrakeMode);
     Brain.Screen.printAt(10, 100, "LT Brake Mode Value: %d", static_cast<int>(leftBrakeMode));
    ...
    Brain.Screen.printAt(10, 120, "RT Brake Mode Value: %d", static_cast<int>(rightBrakeMode));
