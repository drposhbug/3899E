...
const double BLUE_HUE_MAX = 230.0;  // Reduced from 240
   ...
   wait(400, msec);
    ...
    armMotor1.spinToPosition(Load1-30, rotationUnits::deg, 100, velocityUnits::pct, true);
    armMotor2.spinToPosition(Load1-30, rotationUnits::deg, 100, velocityUnits::pct, true);
    rightMP(35,75,20); 
