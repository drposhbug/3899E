...
void autonRoutine9() {
  OdometryTaskParams odomParams;
    odomParams.isRunning = true;
    odomParams.delayMs = 10;
    odomParams.moveRequested = true;
    vex::task odomControl(odometryTask, &odomParams);
    ...
    armParams2.targetPosition = ArmPosition::Starting;
