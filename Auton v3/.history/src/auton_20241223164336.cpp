...
void autonRoutineRedLeft() {  //Blue Safe Route
   ...
   armMotor.spinToPosition(520, rotationUnits::deg, 100, velocityUnits::pct, true);
pidStraightDistanceABS(0, -15, 100, .15, 0, 0, 1, 0, 0, 15, 20);  
spotTurn(-67, 70, 2, 0.4, 0, 0.05);
pidStraightDistanceABS(-70, 28, 80, .15, 0, 0, 1, 0, 0, 15, 20); 
//intakeMotor.spin(directionType::rev, 12, voltageUnits::volt);
armMotor.spinToPosition(-30, rotationUnits::deg, 100, velocityUnits::pct, false);
intakeMotor.spinFor(-2000, rotationUnits::deg, 100, velocityUnits::pct, false);
vex::task::sleep(500); 
armMotor.spinToPosition(-460, rotationUnits::deg, 100, velocityUnits::pct, false);
spotTurn(27, 70, 2, 0.4, 0, 0.05);
pidStraightDistanceABS(24, -55, 80, .15, 0, 0, 1, 0, 0, 10, 40);
goalPneumatics.set(true);
intakeMotor.spinFor(-2000, rotationUnits::deg, 100, velocityUnits::pct, false);
