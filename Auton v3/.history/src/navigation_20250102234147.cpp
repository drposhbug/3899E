...
void straight(double targetHeading, double maxSpeed, double minSpeed, double breakDistanceInDegrees, double accelHeadingScaling, double decelHeadingScaling, double approachHeadingScaling) { 
    double normTargetHeading = normHeading(targetHeading);
    double startingNormHeading = normHeading(InertialSensor.heading(degrees));
    double normCurrentHeading = startingNormHeading;
