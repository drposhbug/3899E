...
int armTask(void* params) {
    ...
    armMotor.spinToPosition(p->position, rotationUnits::deg, p->speed, velocityUnits::pct, false);
    armMotor.spinToPosition(, rotationUnits::deg, p->speed, velocityUnits::pct, false);
    return 0;
}
