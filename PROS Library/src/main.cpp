...
void initialize() {
    pros::lcd::initialize();
    pros::lcd::set_text(1, "Team 3899E Ready!");
...
void autonomous() {
    pros::lcd::clear();
    pros::lcd::print(0, "Running Autonomous Mode...");

    // Start heading display task (autonomous-only)
    headingDisplayParams.isRunning = true;
    pros::Task heading_task(headingDisplayTask, &headingDisplayParams);
    wingPneumatics.set_value(false);

    // Run your autonomous routine here
    // autonTest();
    // autonLeft();
    // autonRight();
    // autonFwdRight();
...
void opcontrol() {
    pros::lcd::clear();
    pros::lcd::print(0, "Running Driver Control Mode...");
